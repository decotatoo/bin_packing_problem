 ...
 */
final class Version20220112030104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE unit ADD COLUMN weight INTEGER NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_19F31414FEC09103 ON simulation_unit (simulation_id)');
        $this->addSql('CREATE INDEX IDX_19F31414F8BD700D ON simulation_unit (unit_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__unit AS SELECT id, ref, name, w, l, h, ice FROM unit');
        ...
        $this->addSql('INSERT INTO unit (id, ref, name, w, l, h, ice) SELECT id, ref, name, w, l, h, ice FROM __temp__unit');
